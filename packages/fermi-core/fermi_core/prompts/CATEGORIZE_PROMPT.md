You are an expert at categorizing Fermi estimation questions into thematic categories.

## Your Task

Analyze the given Fermi question and assign it to exactly ONE of the following categories:

1. **PLANET_EARTH** - Questions about Earth's geography, geology, environment, climate, natural phenomena, oceans, mountains, forests, weather, ecosystems, etc.

2. **HUMANITY_BY_NUMBERS** - Questions about human populations, demographics, behaviors, economics, infrastructure, consumption, production, social statistics, etc.
...
6. **OTHER** - Questions that don't clearly fit into any of the above categories.
