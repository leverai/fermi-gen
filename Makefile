...
run-frontend:
	...
	cd apps/fermi-frontend && \
	fvm flutter run --flavor dev -d emulator-5554 -t lib/main.dart \
...
build-frontend-ios:
	...
	fvm flutter build ipa \
	  ...
	  --dart-define=USE_EMULATORS=false \
	  --dart-define=SUPPRESS_TEST_LOGS=true \
	  --dart-define=REVENUECAT_IOS_API_KEY=appl_tXlAUGczQOVokAqZxWuZXJfLIqg
...
upload-frontend-ios:
	...
	xcrun altool \
		...
		--apiKey HYVM9565J2 \
		--apiIssuer "72f146db-e042-4bdd-a3bb-4ffdaad11035"
